...
function displayQstn() {
    ...
    // quizPostSection.after(dummyButton);
    // quizPostSection.focus();
    var qstnArray = quizData[index].quiz.split("~", 3);
    quizQstn.innerHTML = "";
...
function displayScore() {
    ...
    teamNameLabel.setAttribute("class", "col-lg-3 font-weight-bold");
    teamScoreLabel.setAttribute("class", "col-lg-3 font-weight-bold");
    teamRankLabel.setAttribute("class", "col-lg-3 font-weight-bold");
